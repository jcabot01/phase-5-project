class StudentsController < ApplicationController
  ...
  #Authentication//////////////////////////////////////////////////////////////////////////
 #POST  2 actions: 1)signup to db & 2)set session hash to student_id      session[:student_id]
  #create   /signup
  def create
  ...
  #GET  find user whose id == session[:student_id].  That user is logged in on every page refresh thanks to useEffect in App.js
  #show   /me    
  def show
